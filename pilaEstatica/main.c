...
///#include "../pilaClase_21_5/pilaDinamica.h"
...
int main()
{
//    char cad[]="{x+[2+n]+[5*w(2+x)]}";
//    if(evaluarExpresion(cad))
//    {
//        printf("success!");
//    }
//    else
...
//    }
    ...
    char numero1[TAM]="99999999999999999999"; ///18446744073709551615 max lon long unsigned
    char numero2[TAM]="10000000000000000001";
