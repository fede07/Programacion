...
int main()
{
    ...
    char cadena4[60] = "     todo       a          mayus          ";
    char cadena5[60] = "    hola        pepito ! a  ";
    char cadena6[60] = "         pePiTo       mAxWell           aLto     ";
    ...
    printf("\nCadena original: *%s*", cadena4);
    printf("\nCadena sin espacios: *%s*", todoMayus(cadena4));
    printf("\n");

    printf("\nCadena original: *%s*", cadena5);
    printf("\nCadena sin espacios: *%s*", primerPalabraMayus(cadena5));
    printf("\n");

    printf("\nCadena original: *%s*", cadena6);
    printf("\nCadena sin espacios: *%s*", apellidoIniciales(cadena6));
    printf("\n");
