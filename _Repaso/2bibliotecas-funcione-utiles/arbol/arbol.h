...
///recibe un vector y carga el arbol a partir de eso, el vector tiene que estar en preorden
...
///recibe un archivo y carga el arbol a partir de eso, el archivo tiene que estar en preorden
...
void eliminarElementosArbolNoClave (t_arbol * arbol, const void * filtro, int(*comparar)(const void *, const void *));
